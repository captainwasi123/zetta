...
class equipmentController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('coach.equipment.index');
    
    }

    function add(){

        return view('coach.equipment.add');
    }
    ...
    function insert(Request $request){
        ...
        if ($request->hasFile('main_image')) {
            ...
            $file->move(base_path('/public/storage/user/equipment/'), $filename);
    ...
    function edit($id){
        ...
        if(!empty($data->id)){
            return view('coach.equipment.edit', ['data' => $data]);
        }else{
