      ...
      <div class="row">
        ...
        <div class="col-lg-8 main-section">
          <div class="section-2">
              ...
              <h4 class="sec-1">Object: Lesson confirmation n°ooooo</h4>
              ...
              <p class="sec-4">Enjoy your (sport/sub-category of the gig) lesson, hope you enjoy working with (coaches name).</p>
