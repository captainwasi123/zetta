    ...
    <div class="section-1">    
      <div class="row">
        ...
        <div class="col-lg-8 main-section">
          <div class="section-2">
              <h2>FOLLOW UP FOR CUSTOMER FEEDBACK</h2>
              <h4 class="sec-1">Object: Support email</h4>
              <h4 class="sec-1">Thanks for your email</h4>
              <h4>We’ve received your request, and someone from the Zettaa team will be in touch soon.</h4>
              <p>In the meantime, one of these articles from our FAQ might help get you an instant answer to your question.</p>
