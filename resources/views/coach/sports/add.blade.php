      ...
      <form method="post">
         ...
         <div class="row  m-t-20">
            ...
            <div class="col-md-6 col-lg-6 col-12">
               ...
               <a href="{{route('coach.sports')}}" class="submit-btn1 bg-green2 m-l-10">  BACK </a>
            </div>
         </div>
      </form>
   </div>
               ...
               <tbody>
                  @foreach(Auth::user()->category as $key => $val)
                     <tr>
                        ...
                        <td>
                           <a href="javascript:void(0)" class="btn btn-danger btn-sm deleteItem" data-href="{{route('coach.sports.delete', base64_encode($val->id))}}"><i class="fa fa-trash"></i> Delete </a>
                        </td>
                     </tr>
                  @endforeach
