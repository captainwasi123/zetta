                                             ...
                                             @foreach(Auth::user()->category as $val)
                                                <tr>
                                                   ...
                                                   <td class="text-center">
                                                      <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <img src="{{URL::to('/')}}/assets/user_dashboard/coach/images/wheel-icon.png"> </a>
                                                      <div class="dropdown-menu animated flipInY" style="">
                                                         <a href="{{route('coach.category.edit', base64_encode($val->id))}}" class="dropdown-item"><i class="fa fa-pencil"></i> Edit </a>
                                                         <div class="dropdown-divider"></div>
                                                         <a href="javascript:void(0)" class="dropdown-item deleteItem" data-href="{{route('coach.category.delete', base64_encode($val->id))}}"><i class="fa fa-trash"></i> Delete </a>
                                                      </div>
                                                   </td>
                                                </tr>
                                             @endforeach
