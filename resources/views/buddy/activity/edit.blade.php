             ...
             <div class="row ">
                ...
                <div class="col-md-6 col-lg-6 col-12">
                   <div class="inline-1">
                      ...
                      <input id="radio2" name="availability_for[]" type="checkbox" value="1" class="custom-control-input" {{$availability_for == "1" ? 'checked' :''}}  >
                      ...
                      <label class="custom-control custom-checkbox">
                      <input id="radio1" name="availability_for[]" type="checkbox" value="2" class="custom-control-input"  {{$availability_for == "" ? 'checked' :''}}   >
                      ...
                      <label class="custom-control custom-checkbox">
                      <input id="radio2" name="availability_for[]" type="checkbox" value="3" class="custom-control-input"   {{$availability_for== "" ? 'checked' :''}}  >
