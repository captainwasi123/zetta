...
<div class="box-wrapper1">
   ...
   <div class="block-element">
      <form method="post" enctype="multipart/form-data" action="{{route('buddy.equipment.update')}}">
         @csrf
         ...
         <div class="row center-row">
            <div class="col-md-3 col-lg-3 col-12">
               <div class="field-name">
                  <img src="{{URL::to('/')}}/assets/user_dashboard/buddy/images/field-icon2.png">
         ...
         <div class="row center-row" id="price_block">
            @if($data->package == '1')
               <div class="col-md-3 col-lg-3 col-12">
                  <div class="field-name">
                     <img src="{{URL::to('/')}}/assets/user_dashboard/buddy/images/field-icon4.png">
                     <h5> Price </h5>
                  </div>
               </div>
               <div class="col-md-6 col-lg-6 col-12">
      ...
      <script type="text/javascript">
         ...
         $(document).on('change', 'input[type=radio][name=package]', function() {
            if (this.value == '0') {
               ...
               $('#price_block').html('<div class="col-md-3 col-lg-3 col-12"><div class="field-name"><img src="{{URL::to('/')}}/assets/user_dashboard/buddy/images/field-icon4.png"><h5> Price </h5></div></div><div class="col-md-6 col-lg-6 col-12"><input type="number" step="any" class="form-field1" name="price" style="width: 150px;" required></div>');
            }
         });
      </script>
@endsection