<aside class="left-sidebar desktop">
   <div class="scroll-sidebar">
      <div class="user-profile-header">
         ...
         <p> <a href="{{route('buddy.analytics_and_redeem')}}"> <img src="{{URL::to('/')}}/assets/user_dashboard/buddy/images/coin-icon.png"> </a> <span> Z COINS <b id="buddyCoins"> {{empty(Auth::user()->wallet->coin) ? 0 : Auth::user()->wallet->coin}} </b> </span> <a href="{{route('buddy.favouriteActivity')}}"> <img src="{{URL::to('/')}}/assets/user_dashboard/buddy/images/heart-icon.png"> </a>  </p>
      </div>
