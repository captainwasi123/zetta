...
@section('title', 'Active | All Activities')
@section('content')
                        ...
                        <tbody>
                            @foreach($data as $key => $val)
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" data-toggle="tooltip" data-original-title="Block" class="btn btn-danger btn-sm blockActivity" data-id="{{base64_encode($val->id)}}">
                                            <i class="fa fa-ban"></i>
                                        </a>
                                    </td>
                                </tr>
