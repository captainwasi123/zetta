...
@section('title', 'Blocked | All Lessons')
@section('content')
                        ...
                        <tbody>
                            @foreach($data as $key => $val)
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" data-toggle="tooltip" data-original-title="Active" class="btn btn-success btn-sm activeLesson" data-id="{{base64_encode($val->id)}}">
