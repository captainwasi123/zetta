                        ...
                        <div class="lesson-title-block">
                            ...
                            <div class="zoom-tag">
                                @if ($val->availability == '1')
                                    <img src="{{URL::to('/public/images/zoom-logo.png')}}"> {{ __('content.Only Zoom Classes')}}
                                @endif
                            </div>
             ...
             <div class="row">
                <div class="col-md-12">
                   <div class="review-box">
                      ...
                      <p class="col-white"> {{ __('content.That would be good please share any reference or similar website interms of features
