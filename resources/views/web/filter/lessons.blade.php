                        ...
                        <a href="{{route('lesson.details', base64_encode($val->id))}}">
                           <div class="lesson-block">
                              ...
                              <div class="lesson-title-block">
                                 ...
                                 <h4 class="ellipsis2"> {{empty($val->user) ? 'Unknown' : $val->user->fname.' '.$val->user->lname}} <span> {{ __('content.Coach')}} </span>  </h4>
                                 <div class="zoom-tag">
                              ...
                              <div class="lesson-info-block">
                                 ...
                                 <h6 class="col-white m-b-15" style="float: right; margin-right: -10px;">
                                    <span class="bg-purple col-white custom-btn12 ellipsis3"> {{@$val->sports->name}} </span>
                                 </h6>
                              </div>
