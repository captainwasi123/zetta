                     ...
                     <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-12 col-12">
                           ...
                           <div class="row center-row">
                              <div class="col-md-4 col-lg-4 col-12">
                                 <div class="field-name">
                                    <img src="{{URL::to('/')}}/assets/web/assets/images/field-icon1.png">
                                    <h5> Full Name </h5>
                                 </div>
                              </div>
                           ...
                           <div class="row center-row">
                              <div class="col-md-4 col-lg-4 col-12">
                                 <div class="field-name">
                                    <img src="{{URL::to('/')}}/assets/web/assets/images/field-icon3.png">
                                    <h5> Gender </h5>
                                 </div>
                              </div>
                              <div class="col-md-8 col-lg-8 col-12">
                           ...
                           <div class="row center-row">
                              <div class="col-md-4 col-lg-4 col-12">
                                 <div class="field-name">
                                    <img src="{{URL::to('/')}}/assets/web/assets/images/field-icon19.png">
                                    <h5> Availability </h5>
                                 </div>
                              </div>
                              <div class="col-md-8 col-lg-8 col-12">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-12">
                           <div class="row center-row m-t-30">
                              <div class="col-md-4 col-lg-4 col-12">
                                 <div class="field-name">
                                    <img src="{{URL::to('/')}}/assets/web/assets/images/field-icon13.png">
                                    <h5> Country </h5>
                                 </div>
                              </div>
                              <div class="col-md-8 col-lg-8 col-12">
                           ...
                           <div class="row center-row">
                              <div class="col-md-4 col-lg-4 col-12">
                                 <div class="field-name">
                                    <img src="{{URL::to('/')}}/assets/web/assets/images/field-icon14.png">
                                    <h5> Languages </h5>
                                 </div>
                              </div>
                              <div class="col-md-8 col-lg-8 col-12">
                           ...
                           <div class="row m-b-20">
                              <div class="col-md-4 col-lg-4 col-12">
                                 <div class="field-name m-t-15">
                                    <img src="{{URL::to('/')}}/assets/web/assets/images/field-icon12.png">
                                    <h5> Choose File </h5>
                                 </div>
                              </div>
                              <div class="col-md-8 col-lg-8 col-12">
                           ...
                           <div class="row m-b-20">
                              <div class="col-md-4 col-lg-4 col-12">
                                 <div class="field-name m-t-15">
                                    <img src="{{URL::to('/')}}/assets/web/assets/images/field-icon15.png">
                                    <h5> ID Proof </h5>
                                 </div>
                              </div>
                              <div class="col-md-8 col-lg-8 col-12">
                           ...
                           <div class="col-md-4 col-lg-4 col-12">
                              <div class="field-name">
                                 <img src="{{URL::to('/')}}/assets/web/assets/images/add-pic-icon.png">
                                 <h5> Add Media </h5>
                              </div>
                           </div>
                           <div class="col-md-8 col-lg-8 col-12">
                              ...
                              <div class="col-md-6 col-lg-6 col-sm-6 col-12">
                                 <div class="lesson-block lesson-block3">
                                    <div class="lesson-image-block">
                                       <img src="{{URL::to('/')}}/assets/web/assets/images/lesson-image1.jpg">
                                    </div>
                                    <div class="lesson-info-block">
                                       <h4> <img src="{{URL::to('/')}}/assets/web/assets/images/avatar.jpg"> Della 785 <span> Yoga Coach </span>  </h4>
